...
import { Wallet, TrendingUp, Shield, Zap, ArrowRight, Target, Award, Sparkles } from "lucide-react";
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Features Section */}
      <section id="features" className="py-20 px-4 border-t border-primary/30">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="p-6 border border-destructive/30 rounded-lg bg-card/50 backdrop-blur-sm hover:border-destructive/60 transition-all hover:shadow-lg hover:shadow-destructive/20"
              >
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-2">Goal Planning</h3>
                <p className="text-muted-foreground">
